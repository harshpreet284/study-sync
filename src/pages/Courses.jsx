  ...
  return (
    <div className="flex-grow flex flex-col items-center bg-background p-4 sm:p-8">
      <div className="max-w-[1280px] w-full mt-4 mb-8">
        ...
        {/* Search Bar */}
        <div className="mb-8 max-w-2xl mx-auto md:mx-0 relative">
          <input 
            type="text" 
        ...
        {filteredCourses.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
            ...
            <p className="text-gray text-lg">We couldn't find any courses matching "{debouncedSearchTerm}".<br/>Try adjusting your search criteria.</p>
          </div>
        )}
      </div>
    </div>
